...
class UserController extends Controller {
    ...
    function UserProfile(): Authenticatable {
        return Auth::user();
    }

    function UserLogout(Request $request): Application | Redirector | RedirectResponse {
    ...
    function VerifyOTP(Request $request): JsonResponse {
        try {
            ...
            //! CurrentDate - UpdatedDate > 5 minutes (For OTP Expiry)
